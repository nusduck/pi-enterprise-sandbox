...
- [x] Same Conversation 3 turns → one logical Pi SDK Session
- [x] Turn 2 restores turn 1 tool call + tool result
- [x] Agent service restart continues Conversation
- [x] Compaction then restart still restores
- [x] Restore failure does not create silent new session
- [x] No longer only last-40 plain-text history injection
