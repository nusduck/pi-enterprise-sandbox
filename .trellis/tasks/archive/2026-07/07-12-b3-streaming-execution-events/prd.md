...
- [x] Long command emits live stdout/stderr events
- [x] Logs persisted and pageable
- [x] SSE supports sequence resume
- [x] truncated flag + full log location when truncated
