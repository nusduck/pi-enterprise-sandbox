...
export function IconChat({ size = 18, className = '', ...props }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function IconRuns({ size = 18, className = '', ...props }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function IconSchedules({ size = 18, className = '', ...props }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function IconA2a({ size = 18, className = '', ...props }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function IconSteer({ size = 18, className = '', ...props }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function IconStop({ size = 18, className = '', ...props }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function IconPuzzle({ size = 18, className = '', ...props }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
      ...
      {...props}
    >
      <path d="M19.439 7.85c0-1.57.802-2.5 1.561-2.85V3.5h-5.463c-.35.759-1.28 1.561-2.85 1.561-1.57 0-2.5-.802-2.85-1.561H4.374v1.5c.759.35 1.561 1.28 1.561 2.85 0 1.57-.802 2.5-1.561 2.85v5.463h1.5c.35-.759 1.28-1.561 2.85-1.561 1.57 0 2.5.802 2.85 1.561h5.463v-1.5c-.759-.35-1.561-1.28-1.561-2.85 0-1.57.802-2.5 1.561-2.85v-5.463h-1.5c-.35.759-1.28 1.561-2.85 1.561z" />
    </svg>
  );
}
...
export function IconSubagent({ size = 16, className = '', ...props }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
