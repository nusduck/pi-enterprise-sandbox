...
export function createEnterprisePolicyExtension(options) {
  ...
  function enterprisePolicyExtension(pi) {
    // ask_user now lives in the `user-interaction` extension. It is still
    // classified here (internal_interaction) and intercepted by the tool_call
    // handler below — tool_call is a global Pi event, so registration location
