...
import { OwnerIdentityService } from '../application/owner-identity-service.js';
...
export class ServiceContainer {
  ...
  async createHttpServices() {
    ...
    const ownerIdentityService = new OwnerIdentityService({ db: this.knex, createRepositories });
