...
> **2026-09-12：本文已被 [统一 design](../../design/updrdb-dbpm-deployment.md) 取代，不再作为部署依据。**
> 用户确认三边共享存储可提供；浏览器入口按 HTTPS 设计，域名/证书/终止资源待确认。以下“全 HTTP”、Agent 无文件状态与 VM 工具清单属于旧方案，不代表当前设计或运行证据。
